...
class UserModelTestCase(TestCase):
    ...
    def test__repr__(self):
        ...
        self.assertEqual(repr, f"<User #{self.u1.id}: {self.u1.username}, {self.u1.email}>")
    ...
    def test_search_users(self):
        users = User.search_users("test")
        self.assertEqual(len(users), 2)

        no_users = User.search_users("no-user")
        self.assertEqual(len(no_users), 0)